...
function addPhotoComment(event) {
    var id = event.target.dataset.questionid;
    var type;
    if (id !== null && id !== undefined) {
        type = "question";
    ...
    $.ajax({
        ...
        success: function (comment) {
            ...
            commentElement.innerHTML = "<div class=\"d-flex w-100 justify-content-between\">\n" +
                ...
                "                                        <h5 class=\"mb-1\" data-contain-user-tags data-contain-hashtags>"+usertags(hashtags(comment.text))+"</h5>\n" +
                "                                            <div class=\"text-right\">\n" +
                "                                                <span class=\"btn btn-sm btn-dark fa fa-trash-o\" data-photo-comment-id=\""+comment.id+"\"\n" +
